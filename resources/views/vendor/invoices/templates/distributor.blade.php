...
<html lang="en">
    <head>
        ...
        <style type="text/css" media="screen">
            ...
            img {
                border-style: none;
                max-height: 50px; /* Ensure the image fits within the desired height */
            }
    ...
    <body>
        ...
        <table class="table mt-0">
            <tbody>
                <tr>
                    <td class="border-0 pl-0" width="80%">
                        <div class="flex">
                            <h4 class="text-uppercase flex-1">

                                <!-- <strong>{{ $invoice->name }}</strong> -->
                                 {{-- <strong>BILL</strong><br> --}}
                                 <strong>BAPTIST LITERATURE SERVICE : BOOKROOM : AIZAWL</strong>
                            </h4>
                        </div>
                    </td>
