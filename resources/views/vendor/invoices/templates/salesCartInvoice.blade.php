    ...
    <div class="invoice-container">
        ...
        <div class="details-section">
            ...
            <div class="detail-row">
                ...
                <div class="detail-value">{{ $branch->branch_name }}</div>
            </div>
            <div class="detail-row">
        ...
        <div class="billing-shipping">
            <div class="billed-to">
                ...
                <div>Name: {{ $request['name'] ?? 'N/A' }}</div>
                <div>Address: {{ $request['address'] ?? 'N/A' }}</div>
                <div>Contact No.: {{ $request['phone'] ?? 'N/A' }}</div>
                <div>GSTIN No.: {{ $request['gst_number'] ?? 'N/A' }}</div>
